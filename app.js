...
const INITIAL_SEEDS = {
    news: [
        {
            ...
            category: "ກະສິກຳ",
            content: "ກະຊວງໄດ້ປະກາດໂຄງການທຶນຊ່ວຍເຫຼືອລ້າດ້ານກະສິກຳນິເວດໃໝ່ຢ່າງເປັນທາງການ. ດ້ວຍງົບປະມານທັງໝົດ 15 ລ້ານໂດລາ, ແຜນງານນີ້ມີຈຸດປະສົງເພື່ອສະໜັບສະໜູນສະຫະກອນກະສິກຳອິນຊີທ້ອງຖິ່ນ, ສົ່ງເສີມການໝູນວຽນພືດທຳມະຊາດ ແລະ ສະໜອງທຶນໃຫ້ແກ່ເຄື່ອງສູບນ້ຳພະລັງງານແສງອາທິດສຳລັບຊາວກະສິກອນຂະໜາດນ້ອຍໃນເຂດຫ່າງໄກສອກຫຼີກ.\n\nການສະໝັກຈະເລີ່ມເປີດໃນວັນທີ 1 ກໍລະກົດ 2026. ໂຄງການປະຫວັດສາດນີ້ຄາດວ່າຈະຊ່ວຍເຫຼືອຄົວເຮືອນຊາວກະສິກອນຫຼາຍກວ່າ 5,000 ຄົວເຮືອນໃນໄລຍະທຳອິດ.",
            date: "2026-06-01",
        ...
        },
        {
            ...
            category: "ພະລັງງານ",
            content: "ເອກະສານນະໂຍບາຍນີ້ກຳນົດການປັບປຸງກົດລະບຽບທີ່ຈຳເປັນເພື່ອເລັ່ງການເຊື່ອມຕໍ່ລະບົບໄຟຟ້າແສງອາທິດຂອງຊຸມຊົນ. ມັນໃຫ້ລາຍລະອຽດກ່ຽວກັບອັດຕາຄ່າໄຟຟ້າ, ມາດຕະຖານການເຊື່ອມຕໍ່ທາງດ້ານເຕັກນິກ ແລະ ແນວທາງການເງິນຈຸລະພາກເພື່ອຊຸກຍູ້ໃຫ້ສະພາທ້ອງຖິ່ນສະໜອງທຶນໃຫ້ແກ່ລະບົບພະລັງງານປະສົມຂອງຕົນເອງ.",
            date: "2026-06-02",
            author: "ມາກັສ ເຊັນ",
    ...
    about: {
        ...
        description: "ພວກເຮົາປະສານງານຄວາມພະຍາຍາມໃນລະດັບຊາດເພື່ອສ້າງລະບົບເສດຖະກິດ-ສັງຄົມທີ່ເຂັ້ມແຂງ ຜ່ານໂຄງການຊຸມຊົນທີ່ມີໂຄງສ້າງ, ການພັດທະນາການສຶກສາທີ່ສ້າງສັນ ແລະ ການເຕີບໂຕຂອງຂະແໜງການທີ່ຍືນຍົງ. ຂອບການຮ່ວມມືຂອງພວກເຮົາເຊື່ອມຕໍ່ລະຫວ່າງການອອກແບບນະໂຍບາຍ ແລະ ການຈັດຕັ້ງປະຕິບັດຕົວຈິງໃນພາກສະໜາມ.",
        mission: "ເພື່ອສ້າງຄວາມເຂັ້ມແຂງໃຫ້ແກ່ຊຸມຊົນໂດຍການສ້າງຄວາມອາດສາມາດຂອງສະຖາບັນ, ບຳລຸງສ້າງບຸກຄະລາກອນທ້ອງຖິ່ນ ແລະ ສົ່ງເສີມການພັດທະນາເສດຖະກິດ-ສັງຄົມທີ່ຍືນຍົງ.",
        vision: "ສັງຄົມທີ່ຮັ່ງມີ, ສະເໝີພາບ ແລະ ຍືນຍົງ ບ່ອນທີ່ທຸກຄົນສາມາດເຂົ້າເຖິງຄວາມຮູ້, ໂອກາດໃນການເຕີບໂຕ ແລະ ຊັບພະຍາກອນທີ່ສະອາດ.",
        values: [
            { id: "val-1", title: "ຄວາມຊື່ສັດ", desc: "ຍຶດໝັ້ນໃນຄວາມໂປ່ງໃສ ແລະ ຄວາມຮັບຜິດຊອບຢ່າງສົມບູນໃນທຸກການກະທຳຂອງແຜນງານ." },
            { id: "val-2", title: "ນະວັດຕະກຳ", desc: "ຮັບເອົາເຕັກໂນໂລຊີທີ່ພົ້ນເດັ່ນ ແລະ ວິທີການທີ່ເປັນມິດກັບສິ່ງແວດລ້ອມເພື່ອແກ້ໄຂບັນຫາທີ່ຍາວນານ." },
            { id: "val-3", title: "Sec", desc: "ຮັບປະກັນວ່າວິທີການແກ້ໄຂຂອງພວກເຮົານັ້ນຮັກສາຊັບພະຍາກອນສິ່ງແວດລ້ອມສຳລັບຄົນລຸ້ນຫຼັງ." },
            { id: "val-4", title: "ການມີສ່ວນຮ່ວມຂອງທຸກຄົນ", desc: "ຈັດລຳດັບຄວາມສຳຄັນໃຫ້ແກ່ປະຊາກອນໃນເຂດຫ່າງໄກສອກຫຼີກ ແລະ ຜູ້ທີ່ມີລາຍໄດ້ໜ້ອຍໃນທຸກໆຂະແໜງການ." }
        ]
    },
    org: [
        {
    ...
    contacts: [
        ...
        },
        {
            ...
            message: "ຮຽນ ທ່ານຜູ້ອຳນວຍການ,\n\nຂ້າພະເຈົ້າເປັນນັກຂ່າວອາວຸໂສທີ່ຕິດຕາມນະໂຍບາຍພາກພື້ນໃຫ້ແກ່ໜັງສືພິມ Daily News. ພວກເຮົານຳສະເໜີບົດຄວາມກ່ຽວກັບແຜນງານກະສິກຳແບບຍືນຍົງ 15 ລ້ານໂດລາ ທີ່ໄດ້ປະກາດໄປວານນີ້. ພວກເຮົາສາມາດຂໍເວລານັດໝາຍໂທລະສັບສັ້ນໆ 10 ນາທີກັບ ດຣ. ແວນ ໃນອາທິດນີ້ເພື່ອຂໍບົດສຳພາດໄດ້ຫຼືບໍ່?\n\nດ້ວຍຄວາມຈິງໃຈ,\nDavid Thorne",
            date: "2026-06-02 10:15",
            status: "unread"
        }
    ],
    logs: [
        { id: "log-1", type: "news", text: "ບົດຄວາມຂ່າວສານ 'ແຜນງານກະສິກຳແບບຍືນຍົງ' ໄດ້ຮັບການເຜີຍແຜ່ແລ້ວ", time: "2 ຊົ່ວໂມງກ່ອນ" },
        { id: "log-2", type: "contact", text: "ໄດ້ຮັບຂໍ້ຄວາມຕິດຕໍ່ໃໝ່ຈາກ Johnathan Wright", time: "3 ຊົ່ວໂມງກ່ອນ" },
        { id: "log-3", type: "about", text: "ປັບປຸງວິໄສທັດຫຼັກຂອງອົງກອນໃນການຕັ້ງຄ່າຂໍ້ມູນກ່ຽວກັບແລ້ວ", time: "1 ວັນກ່ອນ" },
        { id: "log-4", type: "news", text: "ຮ່າງເອກະສານນະໂຍບາຍຖືກສ້າງຂຶ້ນໂດຍ ມາກັສ ເຊັນ", time: "1 ວັນກ່ອນ" }
    ]
};
...
let editingEntityId = null; // Used for holding ID while editing
...
function renderCurrentPage() {
    ...
    if (render) {
        // Highlight active sidebar items (based on page filename)
        const filename = window.location.pathname.substring(window.location.pathname.lastIndexOf('/') + 1) || 'index.html';
        document.querySelectorAll('.sidebar-menu-item').forEach(item => {
            const anchor = item.querySelector('a');
            if (anchor) {
                let href = anchor.getAttribute('href') || '';
                // Standardize href path comparison
                if (href === filename || (filename === 'index.html' && href === 'index.html') || (filename === '' && href === 'index.html')) {
...
// Router Mock Object to keep compatibility with existing registrations and CRUD updates
const router = {
...
router.register('#dashboard', (container) => {
    ...
    const unreadContacts = store.db.contacts.filter(c => c.status === 'unread').length;
    ...
    container.innerHTML = `
        <div class="grid-4x">
            ...
            <div class="card stat-card" style="--card-color: var(--accent-cyan); --card-color-glow: rgba(6, 182, 212, 0.4); --card-accent: var(--accent-cyan-gradient)">
                <div>
                    ...
                    <div class="stat-value">${totalSectors}</div>
                </div>
        ...
        <div class="dashboard-layout">
            <div class="card">
                ...
                <!-- SVG Vector Chart for WOW factor -->
            ...
            <div class="card" style="display:flex; flex-direction:column;">
                ...
                <ul class="activity-list" id="dashboard-logs">
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        ` : filteredNews.map(item => `
                            <tr>
                                <td style="width: 80px;">
                                    <img src="${item.image || 'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?w=100'}" 
                                         style="width:50px; height:50px; object-fit:cover; border-radius: var(--border-radius-sm); border: 1px solid var(--border-color);"
                                         onerror="this.src='https://images.unsplash.com/photo-1500937386664-56d1dfef3854?w=100'"
                                    >
                                </td>
                                <td style="max-width: 320px;">
                                    <div style="font-weight:700; color:var(--text-primary); margin-bottom:4px; line-height: 1.4;">${item.title}</div>
                                    <div style="font-size:12px; color:var(--text-muted); text-overflow:ellipsis; overflow:hidden; white-space:nowrap;">
                                        ${item.content}
                                    </div>
                                </td>
                                <td><span style="font-weight:600; font-size:13px">${item.category}</span></td>
                                <td><span style="color:var(--text-secondary); font-size:13px">${item.author}</span></td>
...
window.editTeamMember = function(id) {
    ...
    editingEntityId = id;
    document.getElementById('member-modal-title').textContent = "ແກ້ໄຂຄະນະບໍລິຫານ/ສະມາຊິກທີມ";
...
window.editSector = function(id) {
    ...
    document.getElementById('sector-form-color').value = sec.themeColor || '#4F46E5';
...
window.submitActivityForm = function(event) {
    ...
    const organizer = document.getElementById('activity-form-organizer').value.trim();
...
window.deleteInboxMessage = function(id) {
    ...
    if (confirm("ທ່ານແນ່ໃຈບໍວ່າຕ້ອງການລຶບຂໍ້ຄວາມນີ້ຢ່າງຖາວອນ?")) {
        ...
        if (index > -1) {
            ...
            activeInboxMessageId = store.db.contacts.length > 0 ? store.db.contacts[0].id : null;
            router.handleHashChange();
        }
    }
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (themeBtn) {
        themeBtn.addEventListener('click', () => {
            ...
            toast.show(`ປ່ຽນເປັນຮູບແບບ ${target === 'dark' ? 'ກາງຄືນ' : 'ກາງເວັນ'} ສຳເລັດແລ້ວ.`);
        });
    }
